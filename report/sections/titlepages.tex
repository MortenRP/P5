...
This report looks at the possibilities of using machine intelligence and distributed systems to gather and analyse traffic data. The main focus of this project is machine intelligence where distributed systems is a support part. The system needs to split up traffic so the route network is better utilized. A lot of software used in this project is not made by the group, but taken from other free or open source projects because these elements are not the focus of this project.
}
