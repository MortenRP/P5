...
\todo{skriv om mapgeneration}
\todo{skriv om lagring i database og hvorfor}
\section{Data analysis}
\todo{How do we analyse the GPS data? What information do we infer (speed, probability of traffic congestion, the design of the cost function to change based on traffic data?}
