...
The reason behind this choice, is to seperate the client application from the back end. Without a client server solution we would not be able to collect data from a client, nor be able to communicate between different devices.
...
As just explained the client harvests data from the user, this data can be used as historical data and is something that we would have used, but because of our limited time for this project we, as explained earlier, are using a training set from Beijing.
