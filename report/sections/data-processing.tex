...
Here we discuss how to process the Beijing training set. The overall process is illustrated in \figref{fig:data-processing}.\todo{Revamp hele Data preprocessing}
