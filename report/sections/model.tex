...
\begin{align*}
  e \in E \text{ is a tuple } e=(u, v) \text{ where } u, v \in V
\end{align*}
...
Usually, the weight of an edge is used to choose between edges in search algorithms.
...
\subsection{Estimating observation speed}\label{KR:speed}\todo{Nyligt omskrevet. Læs og ret.} \todo{mangler hvorfor vi har valgt at gøre det sådan her (done?)}
