...
\end{align}
be he \emph{weight function} that maps an edge, timestamp and day of the week, to a predicted speed of traffic.

The weight function works, by using the $speed$ function \ref{eq:speed}