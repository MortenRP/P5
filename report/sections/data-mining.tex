...
\subsection{Generating cost functions}
Intro\todo{Introduction to Generating cost functions}\todo{Remember to state that we are using ideas from AAU study about policy of estimating speed from segments with few observations}
